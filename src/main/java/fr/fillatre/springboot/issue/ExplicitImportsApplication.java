...
public class ExplicitImportsApplication {

    public static void main(String[] args) {
        new SpringApplicationBuilder(ExplicitImportsApplication.class)
                .listeners(
                        new StartupApplicationListener(ExplicitImportsApplication.class),
                        new ShutdownApplicationListener(ExplicitImportsApplication.class))
                .run(args);
    }
}
